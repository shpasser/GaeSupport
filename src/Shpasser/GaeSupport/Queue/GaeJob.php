...
class GaeJob extends Job {

	/**
	 * The Gae queue instance.
	 *
	 * @var \Shpasser\GaeSupport\Queue\GaeQueue
	 */
	protected $qaeQueue;
	 ...
	 * @param  \Shpasser\GaeSupport\Queue\GaeQueue  $gaeQueue
	 * @param  object  $job
	 * @param  bool    $pushed
	 */
	 ...
	 *
	 * @return \Shpasser\GaeSupport\Queue\GaeQueue
	 */
